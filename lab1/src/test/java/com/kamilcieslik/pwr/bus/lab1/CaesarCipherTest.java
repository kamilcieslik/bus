...
public class CaesarCipherTest {
    ...
    public void encryptTextTest() {
        // given
        String fileContent = "abcDEFG123.$.321GFEDcba";
        Integer key = 5;
        ...
        // then
        String expectedEncryptedContent = "ﾙﾘﾗﾶﾵﾴﾳ123.$.321ﾳﾴﾵﾶﾗﾘﾙ";
    ...
    public void decryptTextTest() {
        // given
        String fileContent = "ﾙﾘﾗﾶﾵﾴﾳ123.$.321ﾳﾴﾵﾶﾗﾘﾙ";
        Integer key = 5;
        when(textFileReaderWriter.readFromFile(any())).thenReturn(fileContent);
        ...
        // then
        String expectedDecryptedContent = "abcDEFG123.$.321GFEDcba";
